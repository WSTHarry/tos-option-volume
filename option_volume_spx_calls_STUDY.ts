...
input strike_start = 2700;
input strike_end = 3100;
input date01 = "200422";
input date02 = "200424";
input date03 = "200427";
input type= "C";
input hours_to_graph=10;
...
CallVolAgg.AssignValueColor(if CallVolAgg >= 1000 then CreateColor(35, 158, 201) else Color.DARK_GRAY);





AddLabel(1, "SPX Calls", CreateColor(35, 158, 201));